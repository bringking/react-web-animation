...
export default class BasicGroup extends Component {
  ...
  render() {
    return <div style={{ padding: '12px' }}>
      ...
      <a href='https://github.com/RinconStrategies/react-web-animation/blob/master/demo/src/basic_group.js'>View
        Source</a>
      <div
        style={{
          display: 'flex',
        ...
        <AnimationGroup onReverse={this.onReverse} onPlay={this.onPlay} onFinish={this.onFinish}
