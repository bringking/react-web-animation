...
export default () => <div style={{ padding: '12px' }}>
  ...
  <div style={{ textAlign: 'center' }} className="welcome-animation">
    <svg version='1.1' x='0px' y='0px'
      ...
      <Animated.path keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(20000, 'alternate')} fill='none'
	...
	c0-26.642,33.37-56.076,89.415-75.616C167.398,207.503,231.515,197.628,299.529,197.628z'
      ...
      <Animated.path keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(15000, 'alternate')} fill='none'
	...
	c-23.079-13.31-31.906-56.921-20.834-115.233C153.281,368.316,176.758,307.841,210.736,248.922z'
      ...
      <Animated.path keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(30000, 'alternate')} fill='none'
