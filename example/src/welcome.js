...
const getCenterKeyFrames = () => {
    return [{ transform: 'scale(1)', fill: '#00D8FF', opacity: 1, offset: 0 },
...
const getOrbitKeyFrame = () => {
    return [{ transform: 'rotate3d(1, -1, 1, 0deg)', stroke: '#00D8FF', opacity: 1, offset: 0 },
...
export default () => <div>
    ...
    <div style={{textAlign: 'center'}}>
        <svg version='1.1' x='0px' y='0px'
             width='500px' height='500px' viewBox='0 0 600 600' enable-background='new 0 0 600 600' space='preserve'>
            <Animation keyframes={getCenterKeyFrames()} timing={getCenterTiming(2000)}>
                <circle fill='#00D8FF' cx='299.529' cy='299.628' r='50.167' style={{transformOrigin: 'center center'}}/>
            </Animation>
            <Animation keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(20000,'alternate')}>
                <path fill='none' stroke='#00D8FF' strokeWidth='24' stroke-miterlimit='10' d='M299.529,197.628
	...
	c0-26.642,33.37-56.076,89.415-75.616C167.398,207.503,231.515,197.628,299.529,197.628z'
            ...
            <Animation keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(15000,'alternate')}>
                <path fill='none' stroke='#00D8FF' strokeWidth='24' stroke-miterlimit='10' d='M210.736,248.922
	...
	c-23.079-13.31-31.906-56.921-20.834-115.233C153.281,368.316,176.758,307.841,210.736,248.922z'
            ...
            <Animation keyframes={getOrbitKeyFrame()} timing={getOrbitTiming(30000,'alternate')}>
                <path fill='none' stroke='#00D8FF' strokeWidth='24' stroke-miterlimit='10' d='M210.821,351.482
	...
	C285.567,460.886,244.898,410.344,210.821,351.482z' style={{transformOrigin: 'center center'}}/>
            </Animation>
        </svg>
    </div>
</div>;